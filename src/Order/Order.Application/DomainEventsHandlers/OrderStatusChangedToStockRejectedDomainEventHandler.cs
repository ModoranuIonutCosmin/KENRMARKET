    ...
    DomainEventHandler<OrderStatusChangedToStockRejectedDomainEvent>
{
    ...
    public override async Task Handle(OrderStatusChangedToStockRejectedDomainEvent notification,
        CancellationToken cancellationToken)
    {
        var eventToPublish =
            new OrderStatusChangedToStocksValidationRejectedIntegrationEvent(notification.Order.BuyerId,
                                                                             notification.Order.Id,
                                                                             (OrderStatus)notification.Order
                                                                                 .OrderStatus);
